...
class DocumentsController extends Controller
{
    ...
    function FetchDocuments($search, $category, $sorting, $currency)
    {
        ...
        // return $resource;
        return view("contentshow", ["data" => $search, "documents" => $services, "category" => $category, "sorting" => $sorting, "currency" => $currency, "currency_rate" => $currency_rate, "currencies" => $currencies,"moduleNames"=>$moduleNames]);
    }
