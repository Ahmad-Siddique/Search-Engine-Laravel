        ...
        <form class="mb-3" action="/searching" method="POST">
            ...
            <div>
                @isset($data)
                    ...
                    <button type="submit" class="btn btn-lg btn-outline-primary"><a
                            href="/resources/{{ $data }}/{{ $category }}/{{ $sorting }}">Gallery</a></button>
                    <button type="submit" class="btn btn-lg btn-outline-primary"><a
                            href="/resources/{{ $data }}/{{ $category }}/{{ $sorting }}">Documents</a></button>
                @endisset
            </div>
                            ...
                            @if (!$resource->isEmpty())
                                ...
                                @foreach ($resource as $item)
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <a
                                                href="/images/{{ $data }}/{{ $category }}/{{ $sorting }}">
