                ...
                <div class="row">
                    ...
                    <div class="col-3">
                            <select name="country" class="form-select" aria-label="Default select example">
                                <option value="Pakistan" @if ($country == 'Pakistan') ? selected : null @endif>Pakistan</option>
                                <option value="UAE" @if ($country == 'UAE') ? selected : null @endif>UAE</option>
                                <option value="KSA" @if ($country == 'KSA') ? selected : null @endif>KSA</option>
                                <option value="Kuwait" @if ($country == 'Kuwait') ? selected : null @endif>Kuwait</option>
                                <option value="Egypt" @if ($country == 'Egypt') ? selected : null @endif>Egypt</option>
    ...
    <div>
        @isset($data)
            ...
            <button type="submit" class="btn btn-lg btn-outline-primary"><a
                    href="/services/{{ $data }}/{{ $category }}/{{ $sorting }}">Services</a></button>
            <button type="submit" class="btn btn-lg btn-outline-primary"><a
                    href="/resources/{{ $data }}/{{ $category }}/{{ $sorting }}">Resources</a></button>
            <button type="submit" class="btn btn-lg btn-outline-primary"><a
                    href="/materials/{{ $data }}/{{ $category }}/{{ $sorting }}">Materials</a></button>
        @endisset
    </div>
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="mb-2 mt-2">
                                        ...
                                        <div>Current Salary | {{ $item->Current_Salary }}</div>
