...
<body>
    ...
    <div class="container">
        <div class="">
            <h2 class="mt-4 text-center">Add Currency</h2>
            ...
            <form method="POST"  enctype="multipart/form-data">
                ...
                <label for="Photo" class="form-label">Currency Name</label>
                ...
                <input step="0.01" type="number" class="form-control" id="password" name="price"
